...
class BitField(object):
    ...
    def extract(self, word: int) -> int:
        ...
        """
        shifted = word >> self.from_bit
        return self.mask & shifted
    ...
    def insert(self, value: int, word: int) -> int:
        """Insert value, which should be in the low order
         ...
         """
        insertion = value & self.mask
        shifted = insertion << self.from_bit
        return word | shifted
    ...
    def extract_signed(self, word: int) -> int:
        ...
        return sign_extend(extracted, 1 + self.to_bit - self.from_bit)
