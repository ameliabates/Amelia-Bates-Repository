          ...
          double* vector_x, double *res)
{
	...
	The execution time decreases when the number of threads increases. This means that the parallization was successful.

	When I was testing which number of threads was the fastest, mine came out with 30 threads being the fastest, however, I would have thought that 32 (the maximum) would be the fastest. 30 threads was 53.87% faster than the 1 thread.
	*/
